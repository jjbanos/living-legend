        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="lg:col-span-2 border border-white/10 bg-[#121212] rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-sm">
              <div>
                <div className="text-[#C5A26F] text-xs tracking-widest mb-2">SELF-HOSTED AUTH</div>
                <div className="text-[#a1a1aa]">All protected routes use Auth.js middleware + session validation. Passwords hashed with bcrypt.</div>
              </div>
              <div>
                <div className="text-[#C5A26F] text-xs tracking-widest mb-2">ADMIN ACCESS</div>
                <div className="text-[#a1a1aa]">Gated server-side by the ADMIN_EMAILS environment variable.</div>
              </div>
              <div>
